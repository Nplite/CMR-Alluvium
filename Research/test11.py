...
RTSP = 'rtsp://ProjectTheft2024:Theft@2024@201.202.202.186/cam/realmonitor?channel=1&subtype=0'
...
while True:
    try:
        ...
        # If ROI 1 is not set, prompt user to select it
            ...
            combined_frame3, person_in_roi3, person_count = person_detection_ROI(frame=frame, roi_points=roi_3_pts_np, model=model)
            cv2.polylines(combined_frame3, [roi_3_pts_np], isClosed=True, color=(0, 255, 0), thickness=1)
