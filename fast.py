...
class CameraProcessor:
    ...
    def process_frame(self, frame, model):
        ...
        try:
            ...
            combined_frame1, thresh_ROI1, _, detections = detect_motion(frame, blurred_frame1, model, self.fgbg, self.roi_1_pts_np)
            ...
            # Process ROI 2
            combined_frame2, thresh_ROI2, _, _ = detect_motion(frame, blurred_frame2, model, self.fgbg, self.roi_2_pts_np)
